...
class StreamCrudController extends CrudController
{
    public function setup()
    {
        ...
        */
        ...
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/stream');
        $this->crud->setEntityNameStrings('stream', 'streams');
        ...
        */
        ...
        $this->crud->addField([  // Select2
            ...
            'entity' => 'klass', // the method that defines the relationship in your Model
            'attribute' => 'name', // foreign key attribute that is shown to user
            'model' => "App\Models\Klass" // foreign key model
         ]);
