    ...
    public function setup()
    {
        ...
        */
        ...
        $this->crud->addField([  // Select2
            ...
            'type' => 'select2',
            'name' => 'staff_category_id', // the db column for the foreign key
            'entity' => 'staffcategory', // the method that defines the relationship in your Model
            'attribute' => 'name', // foreign key attribute that is shown to user
            'model' => "App\Models\Staffcategory" // foreign key model
         ]);
        ...
        $this->crud->addColumn([
            ...
            'type' => "select",
            'name' => 'staff_category_id', // the column that contains the ID of that connected entity;
            'entity' => 'staffcategory', // the method that defines the relationship in your Model
            'attribute' => "name", // foreign key attribute that is shown to user
            'model' => "App\Models\Staffcategory", // foreign key model
         ]);
         $this->crud->addColumn([
            // 1-n relationship
            'label' => "Designation", // Table column heading
            'type' => "select",
            'name' => 'designation_id', // the column that contains the ID of that connected entity;
            'entity' => 'designation', // the method that defines the relationship in your Model
            'attribute' => "name", // foreign key attribute that is shown to user
            'model' => "App\Models\Designation", // foreign key model
         ]);
