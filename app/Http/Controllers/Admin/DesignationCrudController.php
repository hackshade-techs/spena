...
class DesignationCrudController extends CrudController
{
    public function setup()
    {
        ...
        |--------------------------------------------------------------------------
        */
        $this->crud->setModel('App\Models\Designation');
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/designation');
        $this->crud->setEntityNameStrings('designation', 'designations');
